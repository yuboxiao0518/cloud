package com.primeton.appframe.common.aspect;
 ...
 * date: 2017年10月17日 下午12:08:03 <br/>
 * 操作日志记录切点类
...
public class LogAspect {
	...
	// Service层切点
	@Pointcut("@annotation(com.primeton.appframe.common.annotation.ServiceLog)")
	public void serviceAspect() {
	}

	// Controller层切点
	@Pointcut("@annotation(com.primeton.appframe.common.annotation.ControllerLog)")
